...
for (raster_file in raster_files) {
               ...
               # Save the relevant PAs as separate spatvector files
               output_filename <- file.path("C:/Users/ogundipe/Documents/OneDrive - Eidg. Forschungsanstalt WSL/visua/new_data/p50/", paste(basename(raster_file), ".shp", sep = ""))
               ...
               # Save the relevant PAs as separate spatvector files
               output_filename2 <- file.path("C:/Users/ogundipe/Documents/OneDrive - Eidg. Forschungsanstalt WSL/visua/new_data/p75/", paste(basename(raster_file), ".shp", sep = ""))
               ...
               # Save the relevant PAs as separate spatvector files
               output_filename3 <- file.path("C:/Users/ogundipe/Documents/OneDrive - Eidg. Forschungsanstalt WSL/visua/new_data/pavg/", paste(basename(raster_file), ".shp", sep = ""))
