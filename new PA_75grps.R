...
output_path <- file.path("C:/Users/ogundipe/Documents/OneDrive - Eidg. Forschungsanstalt WSL/visua/new_data/AI_75/aci_75","acidic.tif")
...
# Set cells with a value of 0 to NA
binary_raster[binary_raster == 0] <- NA
output_path <- file.path("C:/Users/ogundipe/Documents/OneDrive - Eidg. Forschungsanstalt WSL/visua/new_data/AI_75/aci_75","mod.tif")
writeRaster(binary_raster, output_path, overwrite = TRUE)
...
# Set cells with a value of 0 to NA
binary_raster[binary_raster == 0] <- NA
output_path <- file.path("C:/Users/ogundipe/Documents/OneDrive - Eidg. Forschungsanstalt WSL/visua/new_data/AI_75/aci_75","low.tif")
writeRaster(binary_raster, output_path, overwrite = TRUE)
...
# Set cells with a value of 0 to NA
binary_raster[binary_raster == 0] <- NA
output_path <- file.path("C:/Users/ogundipe/Documents/OneDrive - Eidg. Forschungsanstalt WSL/visua/new_data/AI_75/aci_75","moist.tif")
writeRaster(binary_raster, output_path, overwrite = TRUE)
