...
water_bodies1 = crop(water_bodies, ext(masked_raster))
masked_resampled <- resample(masked_raster, water_bodies1)

water_bodies1_cropped <- resample(water_bodies1,masked_raster)

final <- mask(water_bodies1, masked_resampled)
