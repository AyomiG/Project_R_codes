...
# Estimate quantiles for each pixel in the raster (e.g., 0.25, 0.5, 0.75)
quantiles <- calc(final_map, fun = function(x) quantile(x))

# Print or use the 'quantiles' raster as needed
print(quantiles)
...
# Load your raster map
main_map <- rast("C:/Users/ogundipe/Documents/OneDrive - Eidg. Forschungsanstalt WSL/visua/new_data/plots/New folder/alkaline.tif")
